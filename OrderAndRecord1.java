...
{	
	...
	double count;
	JFrame f;
	JButton order,record,half1,half2,half3,half4,full2,full1,full3,full4,cheese,grill,normal,small,med,large,norm,panner,back;
	JButton submit;
	...
	OrderAndRecord1()
	{
		...
		jtext.setText("ITEM"+"\t\t"+"QUANTITY"+"\t\t"+"AMOUNT");
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		if(e.getSource()==half1)
		{
			...
			price=50*count;
			total+=price;
			jtext.append("Momos"+"\t\t"+count+" Half Plate"+"\t\t"+price);
			jtext.append("\n");
		...
		if(e.getSource()==full1)
		{
			...
			total+=price;
			textfield.setText(""+total);
			jtext.append("Momos"+"\t\t"+count+" Full Plate"+"\t\t"+price);
			jtext.append("\n");
			t1.setText("");
		}
		if(e.getSource()==half2)
		{
			...
			total+=price;
			textfield.setText(""+total);
			jtext.append("Chowmien"+"\t "+count+" Half Plate"+"\t\t"+price);
			jtext.append("\n");
			t1.setText("");
		}
		...
		if(e.getSource()==full2)
		{
			...
			total+=price;
			textfield.setText(""+total);
			jtext.append("Chowmien"+"\t "+count+" Full Plate"+"\t\t"+price);
			jtext.append("\n");
			t1.setText("");
		}
		...
		if(e.getSource()==normal)
		{
			...
			total+=price;
			textfield.setText(""+total);
			jtext.append("Normal Burger"+"\t "+count+"\t\t\t"+price);
			jtext.append("\n");
			t1.setText("");
		}
		...
		if(e.getSource()==grill)
		{
			...
			total+=price;
			textfield.setText(""+total);
			jtext.append("Grill Burger"+"\t "+count+"\t\t\t"+price);
			jtext.append("\n");
			t1.setText("");
		}
		...
		if(e.getSource()==small)
		{
			...
			total+=price;
			textfield.setText(""+total);
			jtext.append("Small Pizza"+"\t "+count+"\t\t\t"+price);
			jtext.append("\n");
			t1.setText("");
		}
		...
		if(e.getSource()==med)
		{
			...
			total+=price;
			textfield.setText(""+total);
			jtext.append("Medium Pizza"+"\t "+count+"\t\t\t"+price);
			jtext.append("\n");
			t1.setText("");
		}
		...
		if(e.getSource()==large)
		{
			...
			total+=price;
			textfield.setText(""+total);
			jtext.append("Large Pizza"+"\t "+count+"\t\t\t"+price);
			jtext.append("\n");
			t1.setText("");
		}
		...
		if(e.getSource()==norm)
		{
			...
			total+=price;
			textfield.setText(""+total);
			jtext.append("Veg Roll"+"\t "+count+"\t\t\t"+price);
			jtext.append("\n");
			t1.setText("");
		}
		...
		if(e.getSource()==panner)
		{
			...
			total+=price;
			textfield.setText(""+total);
			jtext.append("Paneer Roll"+"\t "+count+"\t\t\t"+price);
			jtext.append("\n");
			t1.setText("");
		}
		...
		if(e.getSource()==half3)
		{
			...
			total+=price;
			textfield.setText(""+total);
			jtext.append("Chole Bhature"+"\t "+count+"Half Plate"+"\t\t"+price);
			jtext.append("\n");
			t1.setText("");
		}
		...
		if(e.getSource()==full3)
		{
			...
			total+=price;
			textfield.setText(""+total);
			jtext.append("Chole Bhature"+"\t "+count+"Full Plate"+"\t\t"+price);
			jtext.append("\n");
			t1.setText("");
		}
		...
		if(e.getSource()==half4)
		{
			...
			total+=price;
			textfield.setText(""+total);
			jtext.append("Uttapam"+"\t "+count+"Half Plate"+"\t\t\t"+price);
			jtext.append("\n");
			t1.setText("");
		}
		...
		if(e.getSource()==full4)
		{
			...
			total+=price;
			textfield.setText(""+total);
			jtext.append("Uttapam"+"\t "+count+"Full Plate"+"\t\t\t"+price);
			jtext.append("\n");
			t1.setText("");
		}
